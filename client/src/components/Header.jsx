...
const Header = () => {
  ...
  return <header className='fixed backdrop-blur-md z-50 inset-x-0 top-0 flex
  items-center justify-between px-12 md:px-20 py-6'>
      ...
      <nav className='flex items-center justify-center gap-8'>
        <ul className='hidden md:flex items-center justify-center gap-16'>
            ...
            <div className='relative cursor-pointer' onMouseEnter={()=> setIsMenu(true)}>
              ...
              {isMenu && (
                ...
                rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4'>
                  ...
                  px-3 py-2 rounded-md shadow-md bg-gray-100 hover:bg-gray-200 gap-3'>
         ...
         <NavLink to={"/login"}>
            <motion.button {...buttonClick} className="px-4 py-2 
            rounded-md shadow-md bg-lightOverlay border border-red-300 cursor-pointer">
               Login
            </motion.button>
