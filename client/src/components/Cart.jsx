...
const Cart = () => {
  ...
  return (
    <motion.div {...slideIn} className='fixed z-50 top-0 right-0 w-300 md:w-508
    bg-lightOverlay backdrop-blur-md shadow-md h-screen'>
      ...
      <div className='flex-1 flex flex-col items-start justify-start rounded-t-3xl
      bg-zinc-900 h-full py-6 gap-3 relative'>
        {cart && cart?.length > 0 ?
         (<>
         <div className='flex flex-col w-full items-start justify-start gap-3
        h-[65%] overflow-y-scroll scrollbar-none px-4 bg-red-300'>
        ...
        <div className='bg-zinc-800 rounded-t-[60px] w-full h-[35%] flex flex-col
      items-center justify-center px-4 py-6 gap-24  '>
        <div className='w-full flex items-center justify-evenly'>
          <p className='text-3xl text-zinc-500 font-semibold'>Total</p>
          <p className='text-3xl text-orange-500 font-semibold flex items-center 
...
return (
  <motion.div key={index} {...staggerFadeInOut(index)} className='w-full flex items-center
  justify-start bg-zinc-800 rounded-md drop-shadow-md px-4 gap-4 '>
      ...
      <div className='flex items-center justify-start gap-1 w-full'>
        ...
        font-semibold text-red-400 ml-auto '>
          ${itemTotal}
        </p>
      </div>

      <div className='ml-auto flex items-center justify-center gap-3'>
      <motion.div {...buttonClick} className='w-8 h-8 flex items-center justify-center
      rounded-md drop-shadow-md bg-zinc-900 cursor-pointer' 
