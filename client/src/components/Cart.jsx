...
const Cart = () => {
  ...
  return (
    <motion.div
      {...slideIn}
      className="fixed z-50 top-0 right-0 w-300 md:w-508
    bg-lightOverlay backdrop-blur-md shadow-md h-screen overflow-y-auto"
    >
      <div
        className="w-full flex items-center justify-between py-4 pb-12
      px-6"
      >
        <motion.i
          {...buttonClick}
      ...
      <div
        className="flex-1 flex flex-col justify-between rounded-t-3xl
      ...
      >
        {cart && cart?.length > 0 ? (
         ...
         overflow-y-auto px-4 "
            ...
            <div
              className="bg-zinc-800 rounded-t-[60px] w-full flex flex-col
      items-center justify-center px-4 py-6 gap-5  "
            >
              <div className="w-full flex items-center justify-evenly">
                <p className="text-3xl text-zinc-500 font-semibold">Total</p>
                <p
                  className="text-3xl text-orange-500 font-semibold flex items-center 
          justify-center gap-1"
              ...
              <motion.button
                {...buttonClick}
                className="bg-orange-400 w-[70%] px-4 py-3
        text-xl text-headingColor font-semibold hover:bg-orange-500 drop-shadow-md
        rounded-2xl cart"
