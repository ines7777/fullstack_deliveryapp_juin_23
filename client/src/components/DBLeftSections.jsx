...
const DBLeftSections = () => {
  return (
    <div className='h-full py-12 flex flex-col bg-lightOverlay backdrop-blur-md 
    shadow-md min-w-210 w-300 gap-3'>
      ...
      <div className='w-full items-center justify-center flex h-225 mt-auto px-2'>
        ...
        justify-center flex-col gap-3 px-3'>
            <div className='w-12 h-12 border bg-white rounded-full 
