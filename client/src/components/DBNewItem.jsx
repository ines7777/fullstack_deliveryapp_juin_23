...
<div className='w-full flex items-center justify-around gap-3 flex-wrap'>
      ...
      <InputValueField type="number" placeHolder={"Item price here"} 
              ...
              justify-evenly px-24'>
                ...
                <label>
                 ...
                 <div className='relative w-full h-full overflow-hidden rounded-md'>
                  <motion.img  whileHover={{scale:1.15}}  src={imageDownloadURL}
         ...
         <motion.button onClick={submitNewData} {...buttonClick} className='w-9/12 
         py-2 rounded-md bg-red-400 text-primary hover:bg-red-500 cursor-pointer'>
           Save
         </motion.button>
